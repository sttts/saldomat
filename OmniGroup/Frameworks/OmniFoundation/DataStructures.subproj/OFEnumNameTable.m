...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/DataStructures.subproj/OFEnumNameTable.m 98560 2008-03-12 17:28:00Z bungi $");
...
- (int)nextEnum:(int)enumValue;
{
    ...
    enumIndex = [self indexForEnum:enumValue];
    enumCount = [self count];
    enumIndex = (enumIndex + 1) % enumCount;
    return [self enumForIndex:enumIndex];
}
