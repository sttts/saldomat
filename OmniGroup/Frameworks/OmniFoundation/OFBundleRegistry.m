...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/OFBundleRegistry.m 98221 2008-03-04 21:06:19Z kc $")
...
+ (NSArray *)linkedBundles
{
    NSMutableArray *linkedBundles;
    NSBundle *framework;
    NSEnumerator *frameworkEnumerator;

    linkedBundles = [[NSMutableArray alloc] init];
    [linkedBundles autorelease];
