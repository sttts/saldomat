...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/XML/OFXMLDocument.m 98770 2008-03-17 22:25:33Z kc $");
...
- initWithData:(NSData *)xmlData whitespaceBehavior:(OFXMLWhitespaceBehavior *)whitespaceBehavior defaultWhitespaceBehavior:(OFXMLWhitespaceBehaviorType)defaultWhitespaceBehavior error:(NSError **)outError;
{
    ...
    NSError *error = nil;
    if (![self _parseData:xmlData defaultWhitespaceBehavior:defaultWhitespaceBehavior error:&error]) {
        [self release];
        return nil;
    }
