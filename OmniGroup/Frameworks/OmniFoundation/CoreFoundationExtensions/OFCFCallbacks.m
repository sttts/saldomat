...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/CoreFoundationExtensions/OFCFCallbacks.m 98560 2008-03-12 17:28:00Z bungi $");
...
CFStringRef OFUnsignedIntegerCopyDescription(const void *ptr)
{
    ...
    return CFStringCreateWithFormat(kCFAllocatorDefault, NULL, CFSTR("%u"), u);
}
