...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/Tests/OFRationalTests.m 93428 2007-10-25 16:36:11Z kc $");

@interface OFRationalTests : SenTestCase
{
}
...
- (void)testRound
{
    ...
    for(i = 1; i <= 100; i++) {
        ...
        r.lop = 0;  // See comment in OFRationalFromDouble().
