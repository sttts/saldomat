...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/Tests/OFRelativeDateParserTests.m 98221 2008-03-04 21:06:19Z kc $")
...
do { \
	...
	NSLog( @"FAILURE-> String: %@, result:%@, expected: %@ dateFormat:%@, timeFormat:%@", string, result, expectedDate, dateFormat, timeFormat); \
