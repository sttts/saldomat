...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/OpenStepExtensions.subproj/md5c.c 89466 2007-08-01 23:35:13Z kc $")
...
#else
#define MD5_memset(buf, chr, len) memset(buf, chr, len)
#endif
...
unsigned int inputLen;                             /* length of input block */
{
   ...
   */
  if (inputLen >= partLen) {
    MD5_memcpy ((POINTER)&context->buffer[_index], (POINTER)input, partLen);
  ...
  MD5_memcpy 
    ((POINTER)&context->buffer[_index], (POINTER)&input[i], inputLen-i);
}
