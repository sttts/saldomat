...
//
// I've slightly modified the original source.

#import <OmniBase/rcsid.h>

RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/OpenStepExtensions.subproj/sha1.c 68913 2005-10-03 19:36:19Z kc $")
...
#define BIG_ENDIAN
#else
#error Endian-ness not defined
#endif

#ifdef __NATURAL_ALIGNMENT__
// PPC and SPARC need this.
//#warning Turning on SHA1HANDSOFF
#define SHA1HANDSOFF
#endif
...
CHAR64LONG16* block;
    ...
    // Make sure workspace is word-aligned for SPARC
    unsigned long workspace[sizeof(CHAR64LONG16) / sizeof(long)];
...
#if 0  // TJW -- We don't want this, but leaving it here for reference
