...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/OpenStepExtensions.subproj/NSCalendarDate-OFExtensions.m 90130 2007-08-15 07:15:53Z bungi $")
...
// TODO: Why is this using 'int' instead of 'time_t'?
- initWithTime_t:(int)timeValue;
{
    NSCalendarDate *date;

    date = (id)[self initWithTimeInterval:timeValue sinceDate:[isa unixReferenceDate]];
