...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/OFMultipleOptionErrorRecovery.m 98560 2008-03-12 17:28:00Z bungi $")
...
+ (NSError *)errorRecoveryErrorWithError:(NSError *)error object:(id)object options:(id)option1, ...;
{
    ...
    OFMultipleOptionErrorRecovery *recovery = [[self alloc] initWithRecoveries:recoveries];
