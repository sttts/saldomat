...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/OFRegularExpression.m 93428 2007-10-25 16:36:11Z kc $")
...
#define STRING_PARAMETER(state)		(*((unichar **)(state+1)))
...
static inline void writeCharacter(CompileStatus *compile, unichar character)
{
    if (compile->stringPtr) {
        if (!compile->wroteArgument) {
            *(unichar **)compile->writePtr = compile->stringPtr;
            compile->writePtr++;
...
static inline void setNextPointer(ExpressionState *scan, ExpressionState *value)
{
...
static inline void setNextPointerOnArgument(ExpressionState *scan, ExpressionState *value)
{
