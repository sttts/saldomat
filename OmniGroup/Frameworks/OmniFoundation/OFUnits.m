...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/OFUnits.m 98770 2008-03-17 22:25:33Z kc $");
...
- (NSNumber *)conformUnit:(OFUnit *)aUnit toUnit:(OFUnit *)anotherUnit;
{
    ...
    unsigned ix;
    for(;;) {
        ix = [pathA indexOfObjectIdenticalTo:walk];
        if (ix != NSNotFound) {
