...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniFoundation/Scheduling.subproj/OFScheduler.m 98770 2008-03-17 22:25:33Z kc $")
...
- (BOOL)abortEvent:(OFScheduledEvent *)event;
{
	...
	[self scheduleEvents];
        ...
        unsigned objectIndex = [scheduleQueue indexOfObjectIdenticalTo:event inArraySortedUsingSelector:@selector(compare:)];
