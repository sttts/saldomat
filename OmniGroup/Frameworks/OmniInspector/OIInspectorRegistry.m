...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniInspector/OIInspectorRegistry.m 98034 2008-02-27 22:06:18Z wiml $");
...
- (void)editWorkspace:sender;
{
    ...
    NSWindow *window = [editWorkspaceTable window];
    [window center];
    [window makeKeyAndOrderFront:self];
//    [NSApp runModalForWindow:window];
}
