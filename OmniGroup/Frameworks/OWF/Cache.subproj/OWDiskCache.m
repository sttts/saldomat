...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OWF/Cache.subproj/OWDiskCache.m 67560 2005-08-28 06:48:50Z kc $");
    ...
    if (shouldInsert) {
        ...
        switch(enumType) {
            ...
            case OWDiskCacheBytesConcreteType:
                ...
                contentValue = [[stream newCursor] readAllData];
                break;
