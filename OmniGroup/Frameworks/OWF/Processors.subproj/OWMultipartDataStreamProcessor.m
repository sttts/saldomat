...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OWF/Processors.subproj/OWMultipartDataStreamProcessor.m 66176 2005-07-28 17:48:26Z kc $")
...
- (BOOL)readDelimiter;
{
    ...
    NSString *delimiterString = [[@"\n" stringByAppendingString:line] retain];
    delimiterLength = [delimiterString cStringLength];
    delimiter = NSZoneMalloc([self zone], delimiterLength + 1);
    [delimiterString getCString:(char *)delimiter];
