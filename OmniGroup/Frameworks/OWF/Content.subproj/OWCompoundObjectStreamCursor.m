...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OWF/Content.subproj/OWCompoundObjectStreamCursor.m 68913 2005-10-03 19:36:19Z kc $")
...
- (unsigned int)seekToOffset:(int)offset
  fromPosition:(OWCursorSeekPosition)position;
{
    if (abortException)
        [abortException raise];
