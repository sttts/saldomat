...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OIF/OIICCProfile.m 93428 2007-10-25 16:36:11Z kc $");
...
- initWithData:(NSData *)theProfile
{
    ...
    NSLog(@"Allocated %s %p", isa->name, self);
...
- (void)dealloc;
{
    NSLog(@"Deallocated %s %p", isa->name, self);
...
- (void)invalidateWeakRetains
{
    ...
    NSLog(@"Weak retain zappy %s %p", isa->name, self);
