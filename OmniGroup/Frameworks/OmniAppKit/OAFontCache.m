...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniAppKit/OAFontCache.m 93428 2007-10-25 16:36:11Z kc $")
...
+ (NSFont *)fontWithFamily:(NSString *)aFamily size:(float)size bold:(BOOL)boldFlag italic:(BOOL)italicFlag;
{
    OAFontAttributes attributes;
