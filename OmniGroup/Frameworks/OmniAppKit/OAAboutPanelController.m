...
//  Copyright 2005 The Omni Group. All rights reserved.
//
...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniAppKit/OAAboutPanelController.m 79090 2006-09-07 23:55:58Z kc $");
...
- init;
{
    ...
    currentContentVariantIndex = NSNotFound;
...
{
    unsigned int contentVariantCount = [contentVariants count];
    if (contentVariantCount == 0)
	return;
    
    if (currentContentVariantIndex == NSNotFound)
	currentContentVariantIndex = 0;
    else
	currentContentVariantIndex = (currentContentVariantIndex + 1) % contentVariantCount;
