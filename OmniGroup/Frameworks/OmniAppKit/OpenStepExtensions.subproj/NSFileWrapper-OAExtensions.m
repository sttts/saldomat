...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniAppKit/OpenStepExtensions.subproj/NSFileWrapper-OAExtensions.m 98223 2008-03-04 21:07:09Z kc $");
...
- (BOOL)recursivelyWriteHFSAttributesToFile:(NSString *)file;
{
    ...
    if (type || creator) {
        ...
        if (![[NSFileManager defaultManager] changeFileAttributes:hfsAttributes atPath:file])
            success = NO;
