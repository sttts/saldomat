...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniAppKit/OpenStepExtensions.subproj/NSWindowController-OAExtensions.m 98223 2008-03-04 21:07:09Z kc $");
...
+ (NSWindow *)startingLongOperation:(NSString *)operationDescription controlSize:(NSControlSize)controlSize;
{
    ...
    [self startingLongOperation:operationDescription controlSize:controlSize inWindow:window automaticallyEnds:YES];
    return window;
}
