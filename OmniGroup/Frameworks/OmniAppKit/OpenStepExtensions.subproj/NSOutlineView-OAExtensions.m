...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease/2008-03-20/OmniGroup/Frameworks/OmniAppKit/OpenStepExtensions.subproj/NSOutlineView-OAExtensions.m 89466 2007-08-01 23:35:13Z kc $")
...
- (NSArray *)selectedItems;
{
    ...
    [items autorelease];
    for(anIndex = [rowIndices firstIndex]; anIndex != NSNotFound; anIndex = [rowIndices indexGreaterThanIndex:anIndex]) {
